...
.method private constructor <init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V
    ...
    invoke-direct/range {v0 .. v12}, Libf;-><init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;FFF)V
...
.method public constructor <init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;FFF)V
    ...
    iput-object p2, p0, Libf;->a:Landroid/graphics/Rect;

    iput p3, p0, Libf;->b:I

    iput-object p4, p0, Libf;->c:Landroid/graphics/PointF;

    iput-object p5, p0, Libf;->d:Landroid/graphics/PointF;

    iput-object p6, p0, Libf;->e:Landroid/graphics/PointF;

    iput-object p7, p0, Libf;->f:Landroid/graphics/PointF;

    iput-object p8, p0, Libf;->g:Landroid/graphics/PointF;

    iput-object p9, p0, Libf;->h:Landroid/graphics/PointF;

    iput p1, p0, Libf;->i:I

    iput p10, p0, Libf;->j:F

    iput p11, p0, Libf;->k:F

    iput p12, p0, Libf;->l:F
...
.method public constructor <init>(Landroid/graphics/Rect;I)V
    ...
    invoke-direct/range {v0 .. v6}, Libf;-><init>(ILandroid/graphics/Rect;ILandroid/graphics/PointF;Landroid/graphics/PointF;Landroid/graphics/PointF;)V

    return-void
.end method

.method public static a(Landroid/hardware/camera2/params/Face;)Libf;
    .locals 8

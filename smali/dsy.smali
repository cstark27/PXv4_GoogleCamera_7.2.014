...
.method public constructor <init>(Lcom/google/googlex/gcam/YuvReadView;J)V
    ...
    invoke-static {v1, v5}, Lqdv;->a(ZLjava/lang/Object;)V
    ...
    invoke-static {v8}, Lcom/google/googlex/gcam/SWIGTYPE_p_unsigned_char;->getCPtr(Lcom/google/googlex/gcam/SWIGTYPE_p_unsigned_char;)J

    move-result-wide v10

    long-to-int v7, v6

    invoke-static {v10, v11, v7}, Lcom/google/googlex/gcam/BufferUtils;->byteBufferViewOfNativePointer(JI)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v7}, Lcom/google/googlex/gcam/SWIGTYPE_p_unsigned_char;->getCPtr(Lcom/google/googlex/gcam/SWIGTYPE_p_unsigned_char;)J

    move-result-wide v7

    invoke-static {v7, v8, v9}, Lcom/google/googlex/gcam/BufferUtils;->byteBufferViewOfNativePointer(JI)Ljava/nio/ByteBuffer;
    ...
    iput-wide v9, v0, Ldsy;->a:J

    move-object/from16 v9, p1

    iput-object v9, v0, Ldsy;->c:Lcom/google/googlex/gcam/YuvReadView;

    const/4 v9, 0x3

    new-array v9, v9, [Lneb;
    ...
    invoke-direct {v10, v6, v12, v1}, Ldsx;-><init>(Ljava/nio/ByteBuffer;II)V
    ...
    invoke-direct {v1, v7, v2, v6}, Ldsx;-><init>(Ljava/nio/ByteBuffer;II)V
    ...
    invoke-direct {v1, v8, v2, v5}, Ldsx;-><init>(Ljava/nio/ByteBuffer;II)V
    ...
    iput-object v1, v0, Ldsy;->b:Ljava/util/List;
...
.method public final a()Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, Ldsy;->c()I

    move-result v1

    invoke-virtual {p0}, Ldsy;->d()I
...
.method public final c()I
    ...
    iget-object v0, p0, Ldsy;->c:Lcom/google/googlex/gcam/YuvReadView;
...
.method public final e()Ljava/util/List;
    ...
    iget-object v0, p0, Ldsy;->b:Ljava/util/List;

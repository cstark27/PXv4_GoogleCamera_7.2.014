...
.method public static a(Lady;)Ljava/lang/String;
    .locals 8
    ...
    invoke-interface {p0}, Lady;->d()I

    move-result v2

    if-nez v2, :cond_1

    invoke-interface {p0}, Lady;->e()I

    move-result v2

    if-nez v2, :cond_1

    invoke-interface {p0}, Lady;->f()I

    move-result v2

    if-nez v2, :cond_1

    invoke-interface {p0}, Lady;->g()I

    move-result v2

    if-nez v2, :cond_1

    invoke-interface {p0}, Lady;->h()Ljava/util/TimeZone;

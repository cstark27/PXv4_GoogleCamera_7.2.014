...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    iput-object p1, p0, Lqn;->c:Landroid/widget/ProgressBar;
...
.method private final a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Lgp;->a()Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_7

    invoke-direct {p0, v1, p2}, Lqn;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v5, p2}, Lqn;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lqn;->a:Landroid/graphics/Bitmap;
    ...
    :cond_5
    iput-object v0, p0, Lqn;->a:Landroid/graphics/Bitmap;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lqn;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lqn;->b:[I
    ...
    iget-object v1, p0, Lqn;->c:Landroid/widget/ProgressBar;
    ...
    invoke-direct {p0, v7, v0}, Lqn;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, v0}, Lvs;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2, v2}, Lqn;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

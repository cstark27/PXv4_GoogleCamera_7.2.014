...
.method private static requestFeatures(Landroid/content/Context;J[I[ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p3}, Lrcu;->a([I)[Lrcu;

    move-result-object p3

    invoke-static {p4}, Lrcu;->a([I)[Lrcu;
    ...
    invoke-direct {v0, v1, v2}, Lrcv;-><init>(J)V
    ...
    sget-object v2, Lrcj;->a:Landroid/content/ComponentName;
    ...
    :cond_1
    invoke-virtual {v0, v6}, Lrcv;->a(Lrcu;)Z

    move-result v7

    if-nez v7, :cond_0

    iget-object v6, v6, Lrcu;->b:Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {v0, v4}, Lrcv;->a(Lrcu;)Z

    move-result v5

    if-nez v5, :cond_4

    iget-object v4, v4, Lrcu;->b:Ljava/lang/String;

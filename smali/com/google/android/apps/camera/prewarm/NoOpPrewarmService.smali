...
.method public final onCooldown(Z)V
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/prewarm/NoOpPrewarmService;->c:Lmbv;

    invoke-virtual {p1}, Lmbv;->a()V

    iget-object p1, p0, Lcom/google/android/apps/camera/prewarm/NoOpPrewarmService;->b:Lfad;

    invoke-interface {p1}, Lfad;->j()V
...
.method public final onCreate()V
    ...
    invoke-interface {v0, p0}, Lhwl;->a(Lcom/google/android/apps/camera/prewarm/NoOpPrewarmService;)V

    invoke-super {p0}, Landroid/service/media/CameraPrewarmService;->onCreate()V

    new-instance v0, Lhwk;

    invoke-direct {v0, p0}, Lhwk;-><init>(Lcom/google/android/apps/camera/prewarm/NoOpPrewarmService;)V
...
.method public final onPrewarm()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/prewarm/NoOpPrewarmService;->c:Lmbv;

    iget-object v1, p0, Lcom/google/android/apps/camera/prewarm/NoOpPrewarmService;->d:Ljava/lang/Runnable;

    invoke-virtual {v0, v1}, Lmbv;->a(Ljava/lang/Runnable;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/prewarm/NoOpPrewarmService;->b:Lfad;

    invoke-interface {v0}, Lfad;->e()V

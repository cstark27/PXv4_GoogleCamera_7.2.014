...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p2}, Ldhi;-><init>()V

    iput-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Ldhh;

    new-instance p2, Ldhk;
    ...
    invoke-direct {p2, v1}, Ldhk;-><init>(Landroid/graphics/drawable/ShapeDrawable;)V

    iput-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Ldhj;
...
.method constructor <init>(Landroid/content/Context;Ldhh;Ldhj;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Ldhj;
...
.method private static a(Lkms;)I
    .locals 1
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Ldhh;

    invoke-interface {v0, p1}, Ldhh;->a(Landroid/graphics/Canvas;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Ldhj;

    invoke-interface {v0, p1}, Ldhj;->a(Landroid/graphics/Canvas;)V
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->e:Lkms;
    ...
    invoke-static {p3}, Lkfv;->c(Landroid/content/Context;)I
    ...
    invoke-static {p4, p3, p5, v0}, Lkms;->a(IZII)Lkms;

    move-result-object p3

    iput-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->e:Lkms;
    ...
    invoke-static {p3}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a(Lkms;)I

    move-result p3

    invoke-static {p2}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a(Lkms;)I
    ...
    invoke-virtual {p2}, Lmjp;->ordinal()I
...
.method protected final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Ldhh;

    invoke-interface {p3, p1, p2}, Ldhh;->a(II)V

    iget-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Ldhj;

    invoke-interface {p3, p1, p2}, Ldhj;->a(II)V

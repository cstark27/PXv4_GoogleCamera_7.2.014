...
.method private final declared-synchronized b()Lerw;
    .locals 2

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lerw;
    ...
    invoke-interface {v0}, Leed;->b()Lerx;

    move-result-object v0

    invoke-interface {v0}, Lerx;->a()Lerw;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lerw;

    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {v0, v1}, Lerw;->a(Landroid/content/Context;)V
...
.method public final queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b()Lerw;
...
.method public final queryRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-virtual {p1}, Lerw;->b()Lpuf;

    move-result-object p1

    invoke-interface {p1}, Lpuf;->j()Ljava/util/Collection;

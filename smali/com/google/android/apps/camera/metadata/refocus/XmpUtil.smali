...
.method public static createXMPMeta()Laec;
    .locals 1
...
.method public static extractOrCreateXMPMeta(Ljava/lang/String;)Laec;
    .locals 0

    invoke-static {p0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/lang/String;)Laec;
...
.method private static extractXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Z)Laec;
    .locals 5
    ...
    invoke-static {p0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->parseFirstValidXMPSection(Ljava/util/List;)Laec;
    ...
    invoke-interface {v1, v3, v2}, Laec;->d(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    invoke-interface {v1, v3, v2}, Laec;->a(Ljava/lang/String;Ljava/lang/String;)Lafm;

    move-result-object v2

    invoke-interface {v2}, Lafm;->c()Ljava/lang/Object;
    ...
    invoke-static {p0, v2}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->parseExtendedXMPSections(Ljava/util/List;Ljava/lang/String;)Laec;
    ...
    invoke-interface {p1}, Lafn;->b()Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-interface {p1}, Lafn;->a()Ljava/lang/String;
    ...
    invoke-interface {p1}, Lafn;->c()Ljava/lang/Object;

    move-result-object v3

    invoke-interface {p1}, Lafn;->d()Lafj;

    move-result-object p1

    invoke-interface {v1, v0, v2, v3, p1}, Laec;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Lafj;)V
    :try_end_1
...
.method public static extractXMPMeta(Ljava/io/InputStream;)Laec;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Ljava/io/InputStream;Z)Laec;
...
.method public static extractXMPMeta(Ljava/io/InputStream;Z)Laec;
    .locals 1
    ...
    invoke-static {v0, p1}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Z)Laec;
...
.method public static extractXMPMeta(Ljava/lang/String;)Laec;
    .locals 8
...
.method public static extractXMPMeta([B)Laec;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->extractXMPMeta([BZ)Laec;
...
.method public static extractXMPMeta([BZ)Laec;
    .locals 1
...
.method private static parseExtendedXMPSections(Ljava/util/List;Ljava/lang/String;)Laec;
    .locals 9
    ...
    :cond_2
    :try_start_0
    invoke-static {p1}, Laee;->a([B)Laec;
...
.method private static parseFirstValidXMPSection(Ljava/util/List;)Laec;
    .locals 8
    ...
    invoke-static {v0, v2, v3, v4, p0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    :try_start_0
    invoke-static {v3}, Laee;->a([B)Laec;
...
.method private static serializeMeta(Laec;)[B
    .locals 6
    ...
    invoke-virtual {v0}, Lafk;->j()V

    invoke-virtual {v0}, Lafk;->i()V

    invoke-static {p0, v0}, Laee;->a(Laec;Lafk;)[B
...
.method private static writeXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Ljava/io/OutputStream;Laec;Laec;)Z
    .locals 11
    ...
    invoke-static {p3}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->serializeMeta(Laec;)[B
    ...
    :try_start_0
    invoke-interface {p2, v2, v1, v4}, Laec;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Laea; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p2}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->serializeMeta(Laec;)[B
    ...
    invoke-interface {p2, v2, v1}, Laec;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static writeXMPMeta(Ljava/io/InputStream;Ljava/io/OutputStream;Laec;Laec;)Z
    .locals 1
    ...
    invoke-static {v0, p1, p2, p3}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->writeXMPMeta(Lcom/google/android/apps/camera/metadata/refocus/XmpUtil$StreamSlicer;Ljava/io/OutputStream;Laec;Laec;)Z
...
.method public static writeXMPMeta(Ljava/lang/String;Laec;)Z
    .locals 9
    ...
    :cond_2
    :try_start_2
    invoke-static {v1, v2, p1, v0}, Lcom/google/android/apps/camera/metadata/refocus/XmpUtil;->writeXMPMeta(Ljava/io/InputStream;Ljava/io/OutputStream;Laec;Laec;)Z
...
.method public static writeXMPMeta([BLjava/io/OutputStream;Laec;Laec;)Z
    .locals 1

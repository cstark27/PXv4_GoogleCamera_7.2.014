...
.field public final dataset:Lkzd;
...
.field public final location:Lmbp;

.field public final maxNativeMemory:Lfdw;

.field public final memoryManager:Lfeb;

.field public final orientation:I

.field public final reference:Lcom/google/android/apps/refocus/image/ColorImage;

.field public final session:Ligw;

.field public final sessionManager:Lihm;

.field public final startTimeMillis:J

.field public final usageStatistics:Lfad;
...
.method public constructor <init>(Lfeb;Lkzd;IIZLjava/lang/String;Lmbp;Ligw;Lfdw;Lcin;Lfad;Lihm;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->memoryManager:Lfeb;

    iput-object p2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkzd;
    ...
    iput-object p7, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->location:Lmbp;
    ...
    iput-object p8, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Ligw;
    ...
    iput-object p9, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfdw;

    iput-object p10, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gcaConfig:Lcin;

    iput-object p11, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lfad;
    ...
    iput-object p12, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lihm;

    return-void
.end method

.method public constructor <init>(Lfeb;Lkzd;Ljava/util/List;Lcom/google/android/apps/refocus/image/ColorImage;IIZLjava/lang/String;Lmbp;Lihm;Lfdw;Lcin;Lfad;Lilf;Likg;)V
    .locals 0
    ...
    iput-object p9, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->location:Lmbp;
    ...
    invoke-direct {p8, p14, p2, p1}, Lili;-><init>(Lilf;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface/range {p3 .. p8}, Likg;->a(Ljava/lang/String;Lmbp;JLili;)Likh;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Ligw;

    iput-object p10, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lihm;

    iput-object p11, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfdw;

    iput-object p12, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gcaConfig:Lcin;

    iput-object p13, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lfad;
...
.method static synthetic access$100(Lcom/google/android/apps/refocus/processing/DepthmapTask;)Lkzd;
    .locals 0

    iget-object p0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkzd;
...
.method private computeRGBZ(Landroid/content/Context;Lcom/google/android/apps/refocus/processing/ProgressCallback;Z)Lcom/google/android/apps/refocus/image/RGBZ;
    ...
    invoke-static {v0, v3, v2}, Lliv;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v2, v1, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Ligw;

    const v3, 0x7f130326

    new-array v4, v12, [Ljava/lang/Object;

    invoke-static {v3, v4}, Lobs;->a(I[Ljava/lang/Object;)Lkfw;

    move-result-object v3

    invoke-interface {v2, v3}, Ligw;->a(Lkfw;)V

    iget-object v2, v1, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gcaConfig:Lcin;

    move-object/from16 v3, p1

    invoke-static {v3, v2, v0, v8}, Lcom/google/android/apps/refocus/processing/DepthmapTask;->renderRGBZ(Landroid/content/Context;Lcin;Lcom/google/android/apps/refocus/image/RGBZ;Lcom/google/android/apps/refocus/processing/ProgressCallback;)V
...
.method private failAndFinish()V
    ...
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Ligw;
    ...
    invoke-static {v3, v2}, Lobs;->a(I[Ljava/lang/Object;)Lkfw;

    move-result-object v2

    const-string v3, "Processing failed."

    invoke-interface {v0, v2, v1, v3}, Ligw;->a(Lkfw;ZLjava/lang/String;)V
...
.method private getFrame(I)Lcom/google/android/apps/refocus/image/ColorImage;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkzd;

    invoke-virtual {v0, p1}, Lkzd;->a(I)Ljava/lang/String;
...
.method private getNumFrames()I
    ...
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkzd;

    invoke-virtual {v2, v0}, Lkzd;->a(I)Ljava/lang/String;
...
.method private getReferenceBitmap(ZZ)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v2}, Lkzd;->a()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lkzd;->a()Ljava/lang/String;
...
.method private isHighResSupported(Lfeb;)Z
    .locals 4

    iget-object p1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfdw;
...
.method private isValid()Z
    ...
    iget-object v3, v0, Lkzd;->b:Ljava/lang/String;

    if-eqz v3, :cond_2

    new-instance v3, Ljava/io/File;

    invoke-virtual {v0}, Lkzd;->b()Ljava/lang/String;
...
.method private processInternal(Landroid/content/Context;Lfeb;Ligw;)V
    .locals 1

    new-instance v0, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;

    invoke-direct {v0, p3}, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;-><init>(Ligw;)V

    invoke-direct {p0, p2}, Lcom/google/android/apps/refocus/processing/DepthmapTask;->isHighResSupported(Lfeb;)Z
...
.method private removeTemporaryFiles()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkzd;

    invoke-virtual {v1}, Lkzd;->a()Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkzd;

    invoke-virtual {v3}, Lkzd;->a()Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkzd;

    invoke-virtual {v4, v1}, Lkzd;->a(I)Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->dataset:Lkzd;

    invoke-virtual {v5, v1}, Lkzd;->a(I)Ljava/lang/String;
...
.method private static renderRGBZ(Landroid/content/Context;Lcin;Lcom/google/android/apps/refocus/image/RGBZ;Lcom/google/android/apps/refocus/processing/ProgressCallback;)V
    .locals 5
    ...
    invoke-direct {v1, p0, p1}, Lcom/google/android/apps/refocus/processing/FaceDetector;-><init>(Landroid/content/Context;Lcin;)V
...
.method private saveAndFinish(Lcom/google/android/apps/refocus/image/RGBZ;)V
    ...
    iget-object v5, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lfad;
    ...
    invoke-interface/range {v5 .. v10}, Lfad;->a(Ljava/lang/String;Lcom/google/android/libraries/camera/exif/ExifInterface;ZFZ)V

    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Ligw;
    ...
    invoke-direct {v4, v5, p1}, Lmjt;-><init>(II)V

    sget-object p1, Lneg;->c:Lneg;

    invoke-direct {v3, v4, p1}, Ljcd;-><init>(Lmjt;Lneg;)V
    ...
    invoke-virtual {v3, p1}, Ljcd;->a(Lcom/google/android/libraries/camera/exif/ExifInterface;)V

    sget-object p1, Lmjp;->a:Lmjp;

    invoke-virtual {v3, p1}, Ljcd;->a(Lmjp;)V

    invoke-interface {v1, v2, v3}, Ligw;->a(Ljava/io/InputStream;Ljcd;)Lqpq;
...
.method private setExifTags(IILcom/google/android/libraries/camera/exif/ExifInterface;)V
    ...
    iget-object v0, p3, Lcom/google/android/libraries/camera/exif/ExifInterface;->W:Lmmk;

    const/4 v1, 0x0

    iput-object v1, v0, Lmmk;->b:[B
    ...
    invoke-virtual {p3, v0, v1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Lmmv;

    move-result-object v0

    invoke-virtual {p3, v0}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Lmmv;)V
    ...
    invoke-virtual {p3, v0, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Lmmv;
    ...
    invoke-virtual {p3, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Lmmv;)V
    ...
    invoke-virtual {p3, p1, p2}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(ILjava/lang/Object;)Lmmv;

    move-result-object p1

    invoke-virtual {p3, p1}, Lcom/google/android/libraries/camera/exif/ExifInterface;->a(Lmmv;)V

    sget p1, Lcom/google/android/libraries/camera/exif/ExifInterface;->C:I
    ...
    sget-object p2, Lmmp;->a:Lmmp;

    iget-short p2, p2, Lmmp;->b:S
...
# virtual methods
.method public addFinishedCallback(Lmja;)V
    .locals 1
...
.method public enforceAspectRatio(Landroid/graphics/Bitmap;Lcom/google/android/apps/refocus/image/ColorImage;)Landroid/graphics/Bitmap;
    .locals 8
...
.method public getName()Ljava/lang/String;
    ...
    iget-object v0, v0, Lkzd;->b:Ljava/lang/String;

    return-object v0
.end method

.method public getSession()Lhxp;
    .locals 1
...
.method public process(Landroid/content/Context;)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->memoryManager:Lfeb;

    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Ligw;

    invoke-direct {p0, p1, v1, v2}, Lcom/google/android/apps/refocus/processing/DepthmapTask;->processInternal(Landroid/content/Context;Lfeb;Ligw;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v0, p0}, Lmja;->a(Ljava/lang/Object;)V
...
.method public removeFinishedCallback(Lmja;)V
    .locals 1
...
.method public save()Lcom/google/android/apps/refocus/processing/DepthmapTask;
    ...
    invoke-static {v1, v0}, Leav;->b(Ljava/lang/String;I)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-virtual {v5, v2}, Lkzd;->a(I)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->memoryManager:Lfeb;
    ...
    iget-object v8, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->location:Lmbp;

    iget-object v9, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Ligw;

    iget-object v10, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->maxNativeMemory:Lfdw;

    iget-object v11, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->gcaConfig:Lcin;

    iget-object v12, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->usageStatistics:Lfad;

    iget-object v13, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lihm;

    move-object v1, v0

    invoke-direct/range {v1 .. v13}, Lcom/google/android/apps/refocus/processing/DepthmapTask;-><init>(Lfeb;Lkzd;IIZLjava/lang/String;Lmbp;Ligw;Lfdw;Lcin;Lfad;Lihm;)V
...
.method public startSession(Z)V
    ...
    iget-object v2, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->sessionManager:Lihm;

    iget-object v3, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Ligw;

    invoke-interface {v2, v3}, Lihm;->a(Ligw;)V

    const/16 v2, 0x5f

    if-eqz p1, :cond_0

    iget-object p1, p0, Lcom/google/android/apps/refocus/processing/DepthmapTask;->session:Ligw;
    ...
    invoke-static {v2, v0}, Lobs;->a(I[Ljava/lang/Object;)Lkfw;

    move-result-object v0

    sget-object v2, Lihx;->h:Lihx;

    invoke-interface {p1, v1, v0, v2}, Ligw;->a([BLkfw;Lihx;)V

...
.method public constructor <init>(Landroid/net/Uri;Lcom/google/android/apps/refocus/processing/FocusSettings;Lcom/google/android/apps/refocus/image/RGBZ;Ljava/lang/String;Landroid/location/Location;Lcom/google/android/apps/refocus/processing/FaceDetector;Landroid/content/ContentResolver;Lilf;Likg;)V
    .locals 0
    ...
    invoke-direct {p7, p8, p2, p1}, Lili;-><init>(Lilf;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface/range {p2 .. p7}, Likg;->a(Ljava/lang/String;Lmbp;JLili;)Likh;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/apps/refocus/processing/RenderingTask;->session:Likh;
...
.method private processInternal(Landroid/content/Context;Likh;)V
    .locals 5
    ...
    sget-object v2, Lihx;->i:Lihx;

    invoke-virtual {p2, v0, v1, v2}, Likh;->a(Landroid/net/Uri;Lkfw;Lihx;)V

    new-instance v0, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;

    invoke-direct {v0, p2}, Lcom/google/android/apps/refocus/processing/ProgressCallbackImpl;-><init>(Ligw;)V
    ...
    invoke-virtual {v0, v1}, Lmna;->a(Landroid/location/Location;)V
    ...
    invoke-direct {v1, v2, v3}, Ljcd;-><init>(Lmjt;Lneg;)V
    ...
    invoke-virtual {v1, p1}, Ljcd;->a(Lcom/google/android/libraries/camera/exif/ExifInterface;)V

    sget-object p1, Lmjp;->a:Lmjp;

    invoke-virtual {v1, p1}, Ljcd;->a(Lmjp;)V

    invoke-virtual {p2, v0, v1}, Likh;->a(Ljava/io/InputStream;Ljcd;)Lqpq;

    return-void

    :cond_2
    invoke-virtual {p2}, Likh;->b()V
...
.method public getSession()Lhxp;
    ...
    iget-object v0, p0, Lcom/google/android/apps/refocus/processing/RenderingTask;->session:Likh;
...
.method public process(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/apps/refocus/processing/RenderingTask;->processInternal(Landroid/content/Context;Likh;)V

...
.method private final a(III)Z
    ...
    invoke-static {p1}, Ljm;->s(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p1}, Ljm;->h(Landroid/view/View;)I

    move-result v0

    invoke-static {p1}, Ljm;->i(Landroid/view/View;)I

    move-result v2

    invoke-static {p1, v0, p2, v2, p3}, Ljm;->a(Landroid/view/View;IIII)V

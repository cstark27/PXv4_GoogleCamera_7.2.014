...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lauy;->b:Landroid/graphics/Paint;
    ...
    sput-object v0, Lauy;->c:Landroid/graphics/Paint;
    ...
    :goto_0
    sput-object v0, Lauy;->a:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v2}, Landroid/graphics/Paint;-><init>(I)V

    sput-object v0, Lauy;->d:Landroid/graphics/Paint;
...
.method public static a(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static {p1}, Lauy;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v1

    invoke-interface {p0, p2, p3, v1}, Laov;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p0

    invoke-static {p1, p0}, Lauy;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V

    invoke-static {p1, p0, v0}, Lauy;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object p1, Lauy;->b:Landroid/graphics/Paint;
    ...
    invoke-static {v0}, Lauy;->a(Landroid/graphics/Canvas;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    sget-object p0, Lauy;->a:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p1, Lauy;->a:Ljava/util/concurrent/locks/Lock;
...
.method public static b(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 2
    ...
    invoke-interface {p0, p3, v0, v1}, Laov;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p0, p3}, Lauy;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static c(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 1
    ...
    :cond_1
    :goto_0
    invoke-static {p0, p1, p2, p3}, Lauy;->b(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public static d(Laov;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static {p1}, Lauy;->b(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    invoke-interface {p0, v2, v4, p3}, Laov;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p0, p2, p2, v2}, Laov;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    sget-object v2, Lauy;->a:Ljava/util/concurrent/locks/Lock;
    ...
    invoke-static {v2}, Lauy;->a(Landroid/graphics/Canvas;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {p0, p3}, Laov;->a(Landroid/graphics/Bitmap;)V

...
.method private constructor <init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Lgem;I)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lbcr;->b:Landroid/graphics/PointF;

    iput-object p2, p0, Lbcr;->c:Landroid/graphics/PointF;

    iput-object p3, p0, Lbcr;->d:Lgem;
...
.method private final a(Landroid/graphics/PointF;Landroid/graphics/Rect;)Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v1, p0, Lbcr;->d:Lgem;

    invoke-virtual {v1, p1}, Lgem;->a(Landroid/graphics/PointF;)Landroid/graphics/PointF;
    ...
    invoke-static {p1, v1, v2}, Lbcr;->a(III)I
    ...
    invoke-static {p1, v1, p2}, Lbcr;->a(III)I
...
.method public static a(Landroid/graphics/PointF;Landroid/graphics/PointF;I)Lbcr;
    .locals 4
    ...
    invoke-direct {v1, p2}, Lgem;-><init>(I)V

    invoke-direct {v0, p0, p1, v1, v2}, Lbcr;-><init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Lgem;I)V

    return-object v0
.end method

.method public static a(Landroid/graphics/PointF;Landroid/graphics/PointF;II)Lbcr;
    .locals 4
    ...
    invoke-direct {v0, p0, p1, v1, p3}, Lbcr;-><init>(Landroid/graphics/PointF;Landroid/graphics/PointF;Lgem;I)V
...
.method public final a(Landroid/graphics/Rect;)[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v1, p0, Lbcr;->c:Landroid/graphics/PointF;

    invoke-direct {p0, v1, p1}, Lbcr;->a(Landroid/graphics/PointF;Landroid/graphics/Rect;)Landroid/hardware/camera2/params/MeteringRectangle;
...
.method public final b(Landroid/graphics/Rect;)[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v1, p0, Lbcr;->b:Landroid/graphics/PointF;

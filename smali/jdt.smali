...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljdt;->a:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lmbf;Ljem;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ljdt;->b:Landroid/content/Context;

    iput-object p2, p0, Ljdt;->c:Lmbf;

    iput-object p3, p0, Ljdt;->d:Ljem;
...
.method private final a(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    iget-object v1, p0, Ljdt;->b:Landroid/content/Context;
    ...
    iget-object p2, p0, Ljdt;->b:Landroid/content/Context;
    ...
    invoke-direct {v0, p0}, Ljds;-><init>(Ljdt;)V
...
.method public final a(Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    ...
    iget-object v0, p0, Ljdt;->b:Landroid/content/Context;
    ...
    invoke-direct {p0, v0, v1, p1}, Ljdt;->a(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;

    move-result-object p1

    invoke-static {p1}, Ljdt;->a(Landroid/app/AlertDialog$Builder;)Landroid/app/AlertDialog;
...
.method public final c(Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;
    ...
    invoke-direct {p0, v0, v1, p1}, Ljdt;->b(Ljava/lang/String;Ljava/lang/String;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
...
.method public final f(Landroid/content/DialogInterface$OnClickListener;)Lqpq;
    .locals 2

    iget-object v0, p0, Ljdt;->d:Ljem;

    const/4 v1, 0x0

    invoke-interface {v0, v1}, Ljem;->a(Z)Lqpq;

    move-result-object v0

    invoke-virtual {p0, p1}, Ljdt;->e(Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog;

    move-result-object p1

    new-instance v1, Ljdr;

    invoke-direct {v1, p0, p1}, Ljdr;-><init>(Ljdt;Landroid/app/AlertDialog;)V

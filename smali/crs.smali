...
.field private final d:Lmlb;

.field private final e:Ljava/util/concurrent/Executor;


# direct methods
.method public constructor <init>(Landroid/hardware/camera2/CameraManager;Lmlb;Ljava/util/concurrent/Executor;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcrs;->c:Landroid/hardware/camera2/CameraManager;

    iput-object p2, p0, Lcrs;->d:Lmlb;

    iput-object p3, p0, Lcrs;->e:Ljava/util/concurrent/Executor;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcrs;->a:Ljava/lang/Object;
...
.method public final a()Lqpq;
    ...
    :try_start_0
    iget-object v1, p0, Lcrs;->c:Landroid/hardware/camera2/CameraManager;
    ...
    :cond_1
    :goto_0
    iget-object v1, p0, Lcrs;->a:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object v2, p0, Lcrs;->b:Lqqh;
    ...
    iget-object v0, p0, Lcrs;->e:Ljava/util/concurrent/Executor;

    new-instance v1, Lcrq;

    invoke-direct {v1, p0}, Lcrq;-><init>(Lcrs;)V
...
.method public final b()Z
    ...
    invoke-direct {v6, v2}, Lcrr;-><init>(Ljava/util/concurrent/atomic/AtomicBoolean;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_2

    :try_start_2
    iget-object v4, p0, Lcrs;->c:Landroid/hardware/camera2/CameraManager;

    const-string v7, "PollUntilReconnect"

    invoke-static {v5, v7}, Lopw;->a(Lmaj;Ljava/lang/String;)Landroid/os/Handler;
    ...
    iget-object v2, p0, Lcrs;->d:Lmlb;

    const/4 v4, 0x2

    invoke-interface {v2, v4}, Lmlb;->b(I)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-virtual {v5}, Lmbb;->close()V
    :try_end_3
    .catch Landroid/hardware/camera2/CameraAccessException; {:try_start_3 .. :try_end_3} :catch_1
    .catch Ljava/lang/InterruptedException; {:try_start_3 .. :try_end_3} :catch_0
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    iget-object v0, p0, Lcrs;->c:Landroid/hardware/camera2/CameraManager;
    ...
    :cond_0
    :try_start_4
    iget-object v7, p0, Lcrs;->c:Landroid/hardware/camera2/CameraManager;
    ...
    iget-object v4, p0, Lcrs;->d:Lmlb;

    invoke-interface {v4, v2}, Lmlb;->b(I)V
    :try_end_4
    ...
    :try_start_8
    invoke-static {v2, v5}, Lqrg;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lcrs;->d:Lmlb;

    const/4 v1, 0x3

    invoke-interface {v0, v1}, Lmlb;->b(I)V
    :try_end_9

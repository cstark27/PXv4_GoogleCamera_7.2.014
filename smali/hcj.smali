...
.method public constructor <init>(Lmzo;Ljdf;)V
    .locals 1
    ...
    iput-object v0, p0, Lhcj;->d:Ljava/util/Deque;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lhcj;->e:Ljava/util/Deque;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lhcj;->g:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-object p1, p0, Lhcj;->j:Lmzo;

    iput-object p2, p0, Lhcj;->b:Ljdf;
...
.method public final a()V
    ...
    :try_start_0
    iget-object v1, p0, Lhcj;->e:Ljava/util/Deque;
    ...
    iget-object v2, p0, Lhcj;->d:Ljava/util/Deque;
    ...
    iget-object v3, p0, Lhcj;->e:Ljava/util/Deque;

    invoke-interface {v3}, Ljava/util/Deque;->removeFirst()Ljava/lang/Object;

    iget-object v3, p0, Lhcj;->d:Ljava/util/Deque;
    ...
    iget-object v5, p0, Lhcj;->j:Lmzo;

    new-instance v6, Lmxy;
    ...
    invoke-direct {v6, v7}, Lmxy;-><init>(Landroid/media/Image;)V

    invoke-interface {v5, v4, v6}, Lmzo;->a(Lnec;Lnec;)V
...
.method public final close()V
    ...
    iget-object v0, p0, Lhcj;->g:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lhcj;->f:Loej;

    invoke-interface {v0}, Loej;->d()V
    ...
    sget-object v1, Lhch;->a:Ljava/lang/Runnable;
    ...
    :cond_0
    iget-object v1, p0, Lhcj;->d:Ljava/util/Deque;

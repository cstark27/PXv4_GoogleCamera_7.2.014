...
# direct methods
.method public constructor <init>(Landroid/graphics/Bitmap;ILandroid/support/v8/renderscript/RenderScript;Lkzt;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lkzn;->a:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, Lkzn;->c:Landroid/support/v8/renderscript/Allocation;

    iget-object p1, p0, Lkzn;->a:Landroid/graphics/Bitmap;

    invoke-virtual {p1}, Landroid/graphics/Bitmap;->getWidth()I

    move-result p1

    iget-object v0, p0, Lkzn;->a:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, Lkzn;->b:Landroid/graphics/Bitmap;

    invoke-static {p3, p1}, Landroid/support/v8/renderscript/Allocation;->createFromBitmap(Landroid/support/v8/renderscript/RenderScript;Landroid/graphics/Bitmap;)Landroid/support/v8/renderscript/Allocation;

    move-result-object p1

    iput-object p1, p0, Lkzn;->d:Landroid/support/v8/renderscript/Allocation;
    ...
    iput-object p1, p0, Lkzn;->h:Landroid/support/v8/renderscript/Allocation;
    ...
    iput-object p1, p0, Lkzn;->i:Landroid/support/v8/renderscript/Allocation;
    ...
    iput-object p1, p0, Lkzn;->j:Landroid/support/v8/renderscript/Allocation;

    iget-object p1, p0, Lkzn;->h:Landroid/support/v8/renderscript/Allocation;

    iput-object p1, p4, Lkzt;->b:Landroid/support/v8/renderscript/Allocation;
    ...
    :goto_0
    iget-object p1, p0, Lkzn;->i:Landroid/support/v8/renderscript/Allocation;

    iput-object p1, p4, Lkzt;->c:Landroid/support/v8/renderscript/Allocation;
    ...
    :goto_1
    iget-object p1, p0, Lkzn;->j:Landroid/support/v8/renderscript/Allocation;

    iput-object p1, p4, Lkzt;->d:Landroid/support/v8/renderscript/Allocation;

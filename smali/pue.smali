...
.method public final entrySet()Ljava/util/Set;
    ...
    iget-object v0, p0, Lpue;->a:Ljava/util/Set;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lpue;->a()Ljava/util/Set;

    move-result-object v0

    iput-object v0, p0, Lpue;->a:Ljava/util/Set;
...
.method public keySet()Ljava/util/Set;
    ...
    iget-object v0, p0, Lpue;->b:Ljava/util/Set;

    if-nez v0, :cond_0

    new-instance v0, Lpuc;

    invoke-direct {v0, p0}, Lpuc;-><init>(Ljava/util/Map;)V

    iput-object v0, p0, Lpue;->b:Ljava/util/Set;
...
.method public final values()Ljava/util/Collection;
    ...
    iget-object v0, p0, Lpue;->c:Ljava/util/Collection;

    if-nez v0, :cond_0

    new-instance v0, Lpud;

    invoke-direct {v0, p0}, Lpud;-><init>(Ljava/util/Map;)V

    iput-object v0, p0, Lpue;->c:Ljava/util/Collection;

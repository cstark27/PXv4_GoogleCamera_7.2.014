...
.field public mComplicationRenderer:Lxf;
...
.field public final mRendererInvalidateListener:Lxd;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lww;-><init>(Landroid/support/wearable/complications/rendering/ComplicationDrawable;)V
    ...
    invoke-direct {v0, p0}, Lwx;-><init>(Landroid/support/wearable/complications/rendering/ComplicationDrawable;)V

    iput-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRendererInvalidateListener:Lxd;
...
.method public synthetic constructor <init>(Landroid/os/Parcel;Lwv;)V
    .locals 0
...
.method private static setStyleToDefaultValues(Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;Landroid/content/res/Resources;)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a(I)V
...
.method private updateStyleIfRequired()V
    ...
    iget-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lxf;
    ...
    invoke-virtual {v1}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lxh;
    ...
    invoke-virtual {v2}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lxh;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lxf;->a(Lxh;Lxh;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v8, v0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lxf;
    ...
    iget-object v6, v8, Lxf;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Lxf;->c:Landroid/graphics/Rect;
    ...
    iget-object v3, v8, Lxf;->w:Lxe;

    iget-boolean v6, v3, Lxe;->j:Z
    ...
    iget-object v6, v8, Lxf;->z:Lxh;

    invoke-direct {v3, v6, v12, v4, v5}, Lxe;-><init>(Lxh;ZZZ)V

    iput-object v3, v8, Lxf;->w:Lxe;
    ...
    :cond_2
    iget-object v3, v8, Lxf;->v:Lxe;

    move-object v10, v3

    :goto_2
    iget-object v3, v8, Lxf;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v3, v8, Lxf;->l:Lxk;

    invoke-virtual {v3, v12}, Lxk;->b(I)V

    iget-object v3, v8, Lxf;->l:Lxk;

    iget-object v5, v8, Lxf;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Lxf;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3, v5}, Lxk;->a(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v4}, Lxk;->a(Ljava/lang/CharSequence;)V
    ...
    iget-object v4, v8, Lxf;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v5, v8, Lxf;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3, v1}, Lxk;->a(Ljava/lang/CharSequence;)V

    iget-object v1, v8, Lxf;->l:Lxk;

    invoke-virtual {v1, v12}, Lxk;->b(I)V

    goto :goto_4

    :cond_5
    iget-object v1, v8, Lxf;->m:Lxk;

    invoke-virtual {v1, v4}, Lxk;->a(Ljava/lang/CharSequence;)V

    iget-object v1, v8, Lxf;->l:Lxk;

    invoke-virtual {v1, v11}, Lxk;->b(I)V

    :cond_6
    :goto_4
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/Canvas;->save()I

    iget-object v1, v8, Lxf;->c:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    int-to-float v1, v1

    iget-object v2, v8, Lxf;->c:Landroid/graphics/Rect;
    ...
    iget-object v1, v10, Lxe;->h:Lxh;

    invoke-virtual {v8, v1}, Lxf;->a(Lxh;)I

    move-result v1

    int-to-float v2, v1

    iget-object v3, v8, Lxf;->o:Landroid/graphics/RectF;

    iget-object v4, v10, Lxe;->f:Landroid/graphics/Paint;

    invoke-virtual {v7, v3, v2, v2, v4}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V

    iget-object v2, v10, Lxe;->h:Lxh;

    iget-object v2, v2, Lxh;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_7

    invoke-virtual {v10}, Lxe;->a()Z

    move-result v2

    if-nez v2, :cond_7

    iget-object v2, v8, Lxf;->i:Lxj;

    iget-object v3, v10, Lxe;->h:Lxh;

    iget-object v3, v3, Lxh;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v2, v3}, Lxj;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v2, v8, Lxf;->i:Lxj;

    iput v1, v2, Lxj;->a:I

    iget-object v1, v8, Lxf;->n:Landroid/graphics/Rect;

    invoke-virtual {v2, v1}, Lxj;->setBounds(Landroid/graphics/Rect;)V

    iget-object v1, v8, Lxf;->i:Lxj;

    invoke-virtual {v1, v7}, Lxj;->draw(Landroid/graphics/Canvas;)V

    :cond_7
    iget-object v1, v8, Lxf;->p:Landroid/graphics/Rect;
    ...
    :cond_8
    iget-object v1, v8, Lxf;->d:Landroid/graphics/drawable/Drawable;
    ...
    :cond_9
    iget-object v3, v8, Lxf;->e:Landroid/graphics/drawable/Drawable;
    ...
    :cond_a
    :goto_5
    iget-object v3, v10, Lxe;->l:Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v3}, Landroid/graphics/drawable/Drawable;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v3, v8, Lxf;->p:Landroid/graphics/Rect;
    ...
    :cond_b
    :goto_6
    iget-object v1, v8, Lxf;->q:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lxf;->k:Lxj;

    iget-object v3, v8, Lxf;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lxj;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lxf;->f:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v8, Lxf;->g:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lxj;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lxf;->g:Landroid/graphics/drawable/Drawable;
    ...
    :cond_d
    :goto_7
    iget-object v1, v8, Lxf;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    invoke-virtual {v1, v3}, Lxj;->setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    iget-object v2, v2, Lxh;->j:Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v2}, Lxj;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v1, v8, Lxf;->k:Lxj;

    iget-object v2, v10, Lxe;->h:Lxh;

    iget-object v3, v8, Lxf;->q:Landroid/graphics/Rect;

    invoke-virtual {v8, v2, v3}, Lxf;->a(Lxh;Landroid/graphics/Rect;)I
    ...
    iget-object v2, v8, Lxf;->q:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Lxj;->setBounds(Landroid/graphics/Rect;)V
    ...
    :cond_f
    :goto_9
    iget-object v1, v8, Lxf;->r:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lxf;->j:Lxj;

    iget-object v2, v8, Lxf;->h:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v2}, Lxj;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Lxf;->j:Lxj;

    iget-object v2, v10, Lxe;->h:Lxh;

    iget-object v3, v8, Lxf;->r:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Lxf;->r:Landroid/graphics/Rect;
    ...
    :cond_10
    iget-object v1, v8, Lxf;->u:Landroid/graphics/RectF;
    ...
    iget-object v2, v8, Lxf;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v1, v10, Lxe;->c:Landroid/graphics/Paint;
    ...
    iget-object v2, v8, Lxf;->u:Landroid/graphics/RectF;
    ...
    iget-object v6, v10, Lxe;->c:Landroid/graphics/Paint;
    ...
    iget-object v6, v10, Lxe;->d:Landroid/graphics/Paint;
    ...
    :cond_12
    iget-object v1, v8, Lxf;->s:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lxf;->x:Landroid/text/TextPaint;

    iget-object v2, v10, Lxe;->a:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_13

    iput-object v2, v8, Lxf;->x:Landroid/text/TextPaint;

    iget-object v1, v8, Lxf;->l:Lxk;

    iget-object v2, v8, Lxf;->x:Landroid/text/TextPaint;

    invoke-virtual {v1, v2}, Lxk;->a(Landroid/text/TextPaint;)V

    iget-object v1, v8, Lxf;->l:Lxk;

    iget-boolean v2, v10, Lxe;->i:Z

    invoke-virtual {v1, v2}, Lxk;->a(Z)V

    :cond_13
    iget-object v1, v8, Lxf;->l:Lxk;

    iget-object v2, v8, Lxf;->s:Landroid/graphics/Rect;

    invoke-virtual {v1, v7, v2}, Lxk;->a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    :cond_14
    iget-object v1, v8, Lxf;->t:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Lxf;->y:Landroid/text/TextPaint;

    iget-object v2, v10, Lxe;->b:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_15

    iput-object v2, v8, Lxf;->y:Landroid/text/TextPaint;

    iget-object v1, v8, Lxf;->m:Lxk;

    iget-object v2, v8, Lxf;->y:Landroid/text/TextPaint;
    ...
    iget-object v2, v8, Lxf;->t:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Lxf;->o:Landroid/graphics/RectF;

    iget-object v3, v10, Lxe;->g:Landroid/graphics/Paint;
    ...
    iget-object v3, v10, Lxe;->e:Landroid/graphics/Paint;
...
.method getActiveStyle()Lxh;
    ...
    invoke-virtual {v0}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lxh;
...
.method getComplicationRenderer()Lxf;
    .locals 1
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Lxf;->a(Landroid/graphics/Rect;)V
...
.method public onTap(II)Z
    ...
    iget-object v0, v0, Lxf;->b:Landroid/support/wearable/complications/ComplicationData;
...
.method public setComplicationData(Landroid/support/wearable/complications/ComplicationData;)V
    ...
    invoke-virtual {v0, p1}, Lxf;->a(Landroid/support/wearable/complications/ComplicationData;)V
...
.method public setContext(Landroid/content/Context;)V
    ...
    invoke-virtual {v3}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lxh;

    move-result-object v3

    invoke-direct {v0, v1, v2, v3}, Lxf;-><init>(Landroid/content/Context;Lxh;Lxh;)V

    iput-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lxf;

    iget-object v1, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRendererInvalidateListener:Lxd;

    iput-object v1, v0, Lxf;->A:Lxd;
    ...
    :cond_2
    invoke-virtual {v0, v1}, Lxf;->a(Ljava/lang/CharSequence;)V

    :goto_1
    iget-object p1, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Lxf;

    iget-boolean v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRangedValueProgressHidden:Z

    invoke-virtual {p1, v0}, Lxf;->a(Z)V
    ...
    invoke-virtual {p1, v0}, Lxf;->a(Landroid/graphics/Rect;)V
...
.method public setNoDataText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Lxf;->a(Ljava/lang/CharSequence;)V

...
# static fields
.field private static final w:Lkr;
...
.field private final y:Ljd;

.field private final z:Lja;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/NestedScrollView;->w:Lkr;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->y:Ljd;

    new-instance p1, Lja;

    invoke-direct {p1, p0}, Lja;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->z:Lja;

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/NestedScrollView;->setNestedScrollingEnabled(Z)V

    sget-object p1, Landroid/support/v4/widget/NestedScrollView;->w:Lkr;
...
.method private final a(II[I)V
    ...
    :cond_0
    iget-object v2, p0, Landroid/support/v4/widget/NestedScrollView;->z:Lja;
    ...
    invoke-virtual/range {v2 .. v9}, Lja;->a(IIII[II[I)Z
...
.method private final a(II[II[I)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->z:Lja;
...
.method public final a(Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->y:Ljd;

    invoke-virtual {p1, p2}, Ljd;->a(I)V
...
.method public final computeScroll()V
    ...
    invoke-direct {p0, v8}, Landroid/support/v4/widget/NestedScrollView;->b(I)V
...
.method public final getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->y:Ljd;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p4, p0, Landroid/support/v4/widget/NestedScrollView;->v:Lkt;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->v:Lkt;

    iget v0, v0, Lkt;->a:I

    invoke-virtual {p0, p4, v0}, Landroid/support/v4/widget/NestedScrollView;->scrollTo(II)V

    iput-object p2, p0, Landroid/support/v4/widget/NestedScrollView;->v:Lkt;
...
.method protected final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p1}, Lkt;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Landroid/widget/FrameLayout;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->v:Lkt;
...
.method protected final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lkt;-><init>(Landroid/os/Parcelable;)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {v6, v13, v8, v0, v14}, Landroid/support/v4/widget/NestedScrollView;->a(IIII)Z

    move-result v0

    if-eqz v0, :cond_e

    invoke-direct {v6, v8}, Landroid/support/v4/widget/NestedScrollView;->c(I)Z
    ...
    invoke-static {v0, v1, v2}, Lkq;->a(Landroid/widget/EdgeEffect;FF)V
    ...
    invoke-direct {v6, v1, v8}, Landroid/support/v4/widget/NestedScrollView;->a(II)Z

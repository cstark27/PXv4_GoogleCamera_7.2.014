...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lpd;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    sget-object v0, Lmw;->d:[I
    ...
    invoke-virtual {p1, p2, v1}, Lvs;->f(II)I
    ...
    invoke-virtual {p1, p2, v1}, Lvs;->e(II)I
    ...
    invoke-virtual {p1, p2, p3}, Lvs;->f(II)I
...
.method public final a(Lnc;)V
    ...
    invoke-direct {v2, p1}, Lpf;-><init>(Lnc;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Lnc;->b()Landroid/view/Menu;

    move-result-object p1

    check-cast p1, Loe;

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lpr;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lpr;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lpr;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->a:Landroid/content/Context;

    invoke-virtual {p1, v2, v3}, Loe;->a(Los;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lpr;

    iget-object v2, p1, Lpr;->f:Lou;

    iget-object v3, p1, Lnr;->f:Lou;

    if-nez v3, :cond_3

    iget-object v3, p1, Lnr;->d:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Lnr;->f:Lou;

    iget-object v1, p1, Lnr;->f:Lou;

    iget-object v3, p1, Lnr;->c:Loe;

    invoke-interface {v1, v3}, Lou;->a(Loe;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/ActionMenuView;->a(Lpr;)V

    :cond_4
    check-cast v1, Landroid/support/v7/widget/ActionMenuView;

    iput-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->b:Landroid/support/v7/widget/ActionMenuView;

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->b:Landroid/support/v7/widget/ActionMenuView;

    const/4 v1, 0x0

    invoke-static {p1, v1}, Ljm;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final onDetachedFromWindow()V
    ...
    invoke-super {p0}, Lpd;->onDetachedFromWindow()V
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    :cond_0
    invoke-super {p0, p1}, Lpd;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
